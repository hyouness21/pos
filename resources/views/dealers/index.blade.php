...
(function () {
    let _t = null;
    window.dealerSearch = function () {
        clearTimeout(_t);
        _t = setTimeout(function () {
            const params = new URLSearchParams(new FormData(document.getElementById('dealer-filter')));
            ...
            fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                ...
                .then(function (html) {
                    ...
                    const res = doc.getElementById('dealer-results');
                    if (res) document.getElementById('dealer-results').innerHTML = res.innerHTML;
